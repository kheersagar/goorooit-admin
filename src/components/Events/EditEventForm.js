...
import { editEvent, getProfessionals } from '../../redux/api';
...
const EditEventForm = (props) => {
  const { eventData, id, closeToggle, setToggleEdit } = props;
  ...
  const [tempImage, setTempImage] = useState(
    eventData.eventPic ? eventData.eventPic : null
  );
  ...
  const handleSubmit = () => {
    ...
    if (selectedProf.length > 0) {
      ...
      alert('Select professional again');
    }
  };
    ...
    <div className='addArtist-container'>
      {loading ? (
        ...
        <div className='addArtist-personalDetails'>
          ...
          <div className='addArtist-submitDetailDiv width80 btnRow-wise'>
            <button
              className='addArtist-submitDetailBtn width40'
